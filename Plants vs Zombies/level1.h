...
public:
    Level1(RenderWindow& window): Levels(2,2)
    {   
        ...
        lawn = new Screen("Assets/Images/Maps/1 patch.jpg");
        ...
        //Screen bg("Assets/Images/Maps/1 patch.png");
        ...
        while (a)
        {
            ...
            if (level_timer.getElapsedTime().asSeconds() >= limit) {
                ...
                admin.increaseLevelsUnlocked(2);
                level_timer.restart();
            }

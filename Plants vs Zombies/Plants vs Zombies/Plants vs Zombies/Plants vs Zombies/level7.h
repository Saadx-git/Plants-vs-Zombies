...
public:
    Level7(RenderWindow& window) : Levels(0, 4)
    {
        ...
        lawn = new Screen("Assets/Images/Maps/Night.png");
        ...
        while (a)
        {
            ...
            zombie_interaction(zfac, pfac, types_of_zombies, total_plants, grid, a);
